<template>
    <div class="container">
        ...
        <Modal
            ...
            <div slot="footer">
                <Button type="info" size="large" long :loading="modalLoading" @click="handleSubmit('formInline')">确定</Button>
            </div>
        </Modal>
    </div>
</template>
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            return h('Poptip', {
                                props: {
                                    trigger: 'hover',
                                    title: params.row.article.length + '个客群',
                                    placement: 'bottom'
                                }
                            }, [
                                h('Tag', params.row.article.length),
                                h('div', {
                                    slot: 'content'
                                }, [
                                    h('ul', this.tableData[params.index].article.map(item => {
                                        return h('li', {
                                            style: {
                                                textAlign: 'center',
                                                padding: '4px'
            ...
            mockTableData () {
                ...
                for (let i = 0; i < 10; i++) {
                    data.push({
                        ...
                        name: '标签' + Math.floor(Math.random() * 100 + 1),
                        status: i % 2 === 0 ? 0 : 1,
                        article: [
                            {
